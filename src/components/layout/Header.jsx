...
function Header() {
  ...
  return (
    <>
      ...
      >
        <div
          className={`bg-bgWhite w-[90%] lg:[80%] 3k:w-[75%] flex justify-between items-center lg:py-3 4k:py-3 3k:py-3 2xl:px-6 xl:px-6 lg:px-6 4k:px-6 3k:px-6 md:py-6 py-3 px-6 mobile-landscape:py-3 md-landscape:py-3 ${
            scrollPositionY >= 5
