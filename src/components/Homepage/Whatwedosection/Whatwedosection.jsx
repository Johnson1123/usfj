            ...
            <div className="grid gap-2 sm:landscape:grid-cols-2  md:grid-10 sm:landscape:gap-10 md:grid-cols-2 md:gap-10 items-center">
              ...
              <div className="py-4 flex justify-center items-center">
                <div className="flex flex-col gap-4">
                  ...
                  >
                    Spiritual growth is at the heart of everything we do.
                    Through Bible studies, prayer groups, and one-on-one
                    mentorship, we guide individuals on their journey of faith.
                  </p>
                  <Link
                    href="/"
              ...
              <div className="py-4">
                <div className="flex flex-col gap-4">
                  ...
                  <p
                    className={`text-bgBlack/70 font-[400] font-secondaryFont pTextStyle`}
                  >
                    We provide a safe and supportive living environment for
                    young adults who need a stable place to live while they work
              ...
              <div className="py-4">
                <div className="flex flex-col gap-4">
                  ...
                  <p
                    className={`text-bgBlack/70 font-[400] font-secondaryFont pTextStyle`}
                  >
                    We offer educational programs and tutoring to help young
                    adults further their education, pursue new opportunities,
              ...
              <div className="py-4">
                <div className="flex flex-col gap-4">
                  ...
                  <p
                    className={`text-bgBlack/70 font-[400] font-secondaryFont pTextStyle`}
                  >
                    Service to others is a core value at United Servants for
                    Jesus. We encourage our participants to engage with their
              ...
              <div className="py-4">
                <div className="flex flex-col gap-4">
                  ...
                  <p
                    className={`text-bgBlack/70 font-[400] font-secondaryFont pTextStyle`}
                  >
                    Our Health and Wellness Support services are designed to
                    promote balanced living and ensure that young adults are
