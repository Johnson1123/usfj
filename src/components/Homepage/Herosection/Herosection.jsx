             ...
             relative overflow-hidden 2xl:p-6 xl:p-6 lg:p-6 4k:p-6 3k:p-6 p-3 flex justify-start items-end transition-all duration-700 ease-in-out`}
                    >
                        ...
                        <motion.div
                            animate={{
                                opacity:
                                    currentActiveBox === 'box_frame1' ? 1 : 0,
                                zIndex:
                                    currentActiveBox === 'box_frame1'
                                        ? 10
                                        : -10,
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-2.5">
                                <h3 className="uppercase !text-white h3HeadingStyle !font-secondaryFont">
                                    United Servants For Jesus
                                </h3>
                                <p className="!font-manFont font-[600] !text-bgWhite pTextStyle">
                                    Where Faith, Service, and Compassion Unite
                                    to Transform Lives.
                                </p>
                            </div>
                        </motion.div>
                        ...
                        <motion.div
                            animate={{
                                opacity:
                                    currentActiveBox === 'box_frame1' ? 0 : 1,
                                zIndex:
                                    currentActiveBox === 'box_frame1' ? -10 : 0,
                            }}
                            transition={{
                                duration: 0.6,
                                ease: 'backInOut',
             ...
             relative overflow-hidden 2xl:p-6 xl:p-6 lg:p-6 4k:p-6 3k:p-6 md:portrait:p-4 p-3 flex justify-start items-end transition-all duration-700 ease-in-out`}
                    >
                        ...
                        <motion.div
                            animate={{
                                opacity:
                                    currentActiveBox === 'box_frame2' ? 1 : 0,
                                zIndex:
                                    currentActiveBox === 'box_frame2'
                                        ? 10
                                        : -10,
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-2.5">
                                ...
                                <p className="!font-manFont font-[600] !text-bgWhite pTextStyle">
                                    Faith-Driven Service, Integrity, and
                                    Excellence: We serve with unwavering faith,
                                    embodying Christ’s love while upholding the
                                    highest moral standards and striving for
                        ...
                        <motion.div
                            animate={{
                                opacity:
                                    currentActiveBox === 'box_frame2' ? 0 : 1,
                                zIndex:
                                    currentActiveBox === 'box_frame2' ? -10 : 0,
                            }}
                            transition={{
                                duration: 0.6,
                                ease: 'linear',
             ...
             relative overflow-hidden 2xl:p-6 xl:p-6 lg:p-6 4k:p-6 3k:p-6 md:portrait:p-4 p-3 flex justify-start items-end transition-all duration-700 ease-in-out`}
                    >
                        ...
                        <motion.div
                            animate={{
                                opacity:
                                    currentActiveBox === 'box_frame3' ? 1 : 0,
                                zIndex:
                                    currentActiveBox === 'box_frame3'
                                        ? 10
                                        : -10,
...
"
                                >
                                    To be a Christ-centered community that
                                    transforms lives through faith, service, and
                                    excellence, spreading God’s love and making
                        ...
                        <motion.div
                            animate={{
                                opacity:
                                    currentActiveBox === 'box_frame3' ? 0 : 1,
                                zIndex:
                                    currentActiveBox === 'box_frame3' ? -10 : 0,
                            }}
                            transition={{
                                duration: 0.6,
                                ease: 'linear',
             ...
             relative overflow-hidden xl:landscape:hidden 2xl:p-6 xl:p-6 lg:p-6 4k:p-6 3k:p-6 md:portrait:p-4 p-3 flex justify-start items-end transition-all duration-700 ease-in-out`}
                    >
                        ...
                        <motion.div
                            animate={{
                                opacity:
                                    currentActiveBox === 'box_frame4' ? 1 : 0,
                                zIndex:
                                    currentActiveBox === 'box_frame4'
                                        ? 10
                                        : -10,
...
"
                        ...
                        <motion.div
                            animate={{
                                opacity:
                                    currentActiveBox === 'box_frame4' ? 0 : 1,
                                zIndex:
                                    currentActiveBox === 'box_frame4' ? -10 : 0,
                            }}
                            transition={{
                                duration: 1.2,
                                ease: 'backInOut',
                ...
                <div className="hidden 2xl:w-[20%] xl:w-[20%] lg:w-[25%] lg:landscape:w-[25%]  2xl:h-full xl:h-full lg:h-full md:h-[40%] h-[35%] relative rounded-3xl overflow-hidden flex-shrink-0 2xl:p-4 xl:p-4 lg:p-4 4k:p-4 3k:p-4 md:p-4 lg:px-2 p-2 xl:landscape:flex justify-center items-center">
                    ...
                    <div className="relative w-full h-full bg-bgWhite/10 backdrop-blur-sm rounded-3xl p-5 flex flex-col">
                        ...
                        <div className="flex flex-col 2xl:gap-5 xl:gap-5 lg:gap-5 4k:gap-5 3k:gap-5 md:gap-3 gap-2 mt-5">
                            ...
                            <p className="!font-manFont font-[600] !text-bgWhite pTextStyle">
                                Our mission is to foster a community where our
                                shared faith drives action.
                            </p>
                        </div>
