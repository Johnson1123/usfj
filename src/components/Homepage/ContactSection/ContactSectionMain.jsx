...
function ContactSectionMain() {
  return (
    <div className="bg-bgBlue py-32 xl:min-h-[100vh] xl:py-[8rem] 3k:py-[20rem] flex items-center">
      <Container>
        <div className="grid grid-cols-1 xl:w-[80%] 3k:w-[70%] xl:mx-auto mobile-landscape:grid-cols-2 md:grid-cols-2 xl:grid-cols-5  md:gap-[10vw] md:items-center mobile-landscape:items-center md-landscape:items-center">
